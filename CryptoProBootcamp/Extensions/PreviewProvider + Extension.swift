...
import SwiftUI
/*
в этом файле мы создаем расщирения для PreviewProvider чтобы можно было показывать одну монету не заполняя класс CoinModel каждый раз
 создаем класс DeveloperPreview где создаем одну монету на основе CoinModel
 в расширении создаем static свойство и возвращаем экземпляр созданного класса
 в коде при вызове аргумента просто укажем dev.coin
*/
...
class DeveloperPreview {
    ...
    let coin = CoinModel(
       ...
       currentHoldings: 1.5)
    let stat1 = StatisticModel(title: "Market Map", value: "12.5Bn", percentageChange: -25.34)
